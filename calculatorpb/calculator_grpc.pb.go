...
func (c *calculatorClient) Sub(ctx context.Context, in *SubRequest, opts ...grpc.CallOption) (*SubResponse, error) {
	out := new(SubResponse)
	err := c.cc.Invoke(ctx, "/calculatorpb.Calculator/Sub", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calculatorClient) Mul(ctx context.Context, in *MulRequest, opts ...grpc.CallOption) (*MulResponse, error) {
	out := new(MulResponse)
	err := c.cc.Invoke(ctx, "/calculatorpb.Calculator/Mul", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calculatorClient) Div(ctx context.Context, in *DivRequest, opts ...grpc.CallOption) (*DivResponse, error) {
	out := new(DivResponse)
	err := c.cc.Invoke(ctx, "/calculatorpb.Calculator/Div", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCalculatorServer) Mul(context.Context, *MulRequest) (*MulResponse, error) {
...
func _Calculator_Sub_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculatorpb.Calculator/Sub",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Calculator_Mul_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculatorpb.Calculator/Mul",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Calculator_Div_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculatorpb.Calculator/Div",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
